# -*- coding: utf-8 -*-
"""european_options_class_py.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1brzDXKH_6FDm9Zu2dhUooUvUIIocDGj-

We shall download it as py file, which can be imported later.
To do this, we shall delete all unnecessary explanations.
